...
const COMPETITORS: Record<string, Competitor> = {
  'vs-zety': {
    ...
    features: [
      ...
      { name: 'Pricing', us: 'Credits from ₹199', them: '$24.95/mo (subscription)' },
      { name: 'Public shareable link', us: true, them: false },
      { name: 'Drag-and-drop editor', us: true, them: true },
    ],
    summary:
      "MyResumeCompany is more affordable than Zety — no subscription required, just buy credits when you need them starting from ₹199. You also get unique features Zety lacks: an AI full resume generator, ATS optimizer that rewrites your bullets, and free PDF exports on the free tier. Zety has a larger template library and strong brand recognition, but charges $24.95/month every month with no pay-as-you-go option.",
    overview: [
    ...
    weaknesses: [
      "Pricing is significantly higher at $24.95/month — and that is a mandatory subscription. MyResumeCompany requires no subscription at all: buy credit packs starting from ₹199 and pay only when you need to build or improve your resume.",
    ...
    whoShouldChoose: {
      ...
      us: "Choose MyResumeCompany if you want advanced AI capabilities without a monthly subscription. Our AI full resume generator creates an entire resume tailored to your target role, our ATS scanner gives you a specific 0-100 score, and our ATS optimizer rewrites your bullet points to match the exact job description you are applying to. There is no subscription — just buy credit packs from ₹199 when you need them. Credits never expire. Our free tier also lets you actually export a PDF, so you can try before you buy."
    },
    pricingComparison:
      "Zety's Pro plan is priced at $24.95 per month with no annual discount publicly available — that works out to roughly $300 per year if you stay subscribed. MyResumeCompany has no subscription at all. You buy credit packs only when you need them: ₹199 for 100 credits, ₹499 for 300 credits, or ₹899 for 800 credits — and your credits never expire. On Zety's free tier, you can build a resume but cannot download it as a PDF, which many users find frustrating after spending time on their resume. MyResumeCompany's free tier includes 100 credits — enough to use AI features and export at least one complete resume as a PDF without paying anything. Zety is subscription-only with no pay-as-you-go option. MyResumeCompany is the opposite: no subscription, no recurring charge, just buy what you need when you need it. For job seekers who build resumes occasionally, this is a much better deal.",
    faq: [
      {
        question: 'Is Zety worth the price at $24.95/month?',
        answer: 'Zety is a solid resume builder with good templates and writing guidance, but at $24.95/month it is one of the most expensive options on the market — and it locks you into a subscription. MyResumeCompany requires no subscription: buy credit packs from ₹199 and pay only when you need to. If you primarily need AI-powered resume writing, ATS optimization, and PDF exports, MyResumeCompany offers all of those features at a fraction of the cost. Zety may be worth it if you specifically value their pre-written phrase library and multilingual support.'
      },
      {
  ...
  'vs-resume-io': {
    ...
    features: [
      ...
      { name: 'PDF export on free plan', us: true, them: false },
      { name: 'Pricing', us: 'Credits from ₹199', them: '$15/mo (subscription)' },
      { name: 'Public shareable link', us: true, them: false },
      { name: 'Drag-and-drop editor', us: true, them: true },
    ],
    summary:
      "MyResumeCompany stands out with its ATS scanner and optimizer — features Resume.io does not offer. Our AI can generate entire resumes from scratch and rewrite bullets to match specific job descriptions. Resume.io has more templates and a clean interface, but fewer AI capabilities, no ATS-specific tools, and a mandatory $15/month subscription. MyResumeCompany has no subscription — buy credit packs from ₹199 and pay only when you need to.",
    overview: [
      ...
      "Where Resume.io falls short is in advanced AI and ATS optimization features. The platform does not include an ATS scanner that scores your resume against a job description, nor does it offer an optimizer that rewrites your content to improve ATS compatibility. As applicant tracking systems become more sophisticated and more employers rely on them to screen candidates, the absence of these features is a notable gap. Resume.io charges $15/month as a mandatory subscription with no pay-as-you-go option, while MyResumeCompany uses a credit pack model — no subscription required, buy only what you need. The free tier is limited to building one resume without PDF export."
    ],
    strengths: [
    ...
    whoShouldChoose: {
      ...
      us: "Choose MyResumeCompany if you want AI that goes beyond basic writing suggestions — with no monthly subscription. Our AI full resume generator creates a complete, tailored resume from your experience and target role. Our ATS scanner gives you a specific score with actionable feedback, and our ATS optimizer rewrites your bullet points to match the job you are applying to — a feature no other builder offers. There is no subscription: buy credit packs from ₹199 when you need them, and your credits never expire. Plus a free tier that actually lets you export a PDF."
    },
    pricingComparison:
      "Resume.io charges $15 per month for their Pro plan — a mandatory subscription with no pay-as-you-go option. MyResumeCompany has no subscription at all. You buy credit packs only when you need them: ₹199 for 100 credits, ₹499 for 300 credits, or ₹899 for 800 credits — and your credits never expire. Resume.io's free tier allows you to build one resume but does not include PDF export, meaning you cannot actually use your resume without paying. MyResumeCompany's free tier includes 100 credits, which is enough to generate AI bullet points, run an ATS scan, and export a PDF — a genuine trial of the full product with no credit card required. For job seekers who build or update resumes occasionally, the credit pack model is a significantly better deal than committing to a monthly subscription.",
    faq: [
      {
      ...
      },
      {
        ...
        answer: 'Resume.io offers a solid, clean resume builder with a good template library and cover letter support. At $15/month, it requires a subscription to access anything useful. MyResumeCompany offers more AI features — including a full resume generator and ATS optimizer — with no subscription required. Buy credit packs from ₹199 and pay only when you need to. If AI-powered resume writing and ATS optimization matter to you, MyResumeCompany provides better value without the monthly commitment.'
      },
      {
  ...
  'vs-canva': {
    ...
    whoShouldChoose: {
      ...
      us: "Choose MyResumeCompany if you are applying to jobs online through company websites, job boards, or application portals — which is how the vast majority of jobs are filled today. Our templates are tested against real ATS systems to ensure your resume gets parsed correctly. Our ATS scanner gives you a specific compatibility score, and our optimizer rewrites your bullets to match the job description. Combined with AI writing tools and a no-subscription credit pack model (from ₹199, credits never expire), MyResumeCompany is built for the reality of modern job applications — without the monthly commitment."
    },
    pricingComparison:
      "Canva's free tier is genuinely free — you can create and download resumes as PDFs at no cost, though you will see ads and some premium templates require Canva Pro ($12.99/month). MyResumeCompany's free tier includes 100 credits, which covers AI content generation and PDF export without ads. Unlike Canva, MyResumeCompany has no subscription model at all — you buy credit packs only when you need them: ₹199 for 100 credits, ₹499 for 300 credits, or ₹899 for 800 credits. Credits never expire, so there is no pressure to use them before a billing cycle resets. Canva Pro at $12.99/month covers the full Canva design suite (presentations, social media, etc.), but if you only need it for resumes, MyResumeCompany is a smarter choice: you get resume-specific AI tools and ATS compatibility that Canva simply does not offer, with no recurring charge. If you already pay for Canva Pro for other design needs, you still benefit from using MyResumeCompany for your actual job applications to ensure ATS compatibility.",
    faq: [
      {
