...
// Register standard web-safe fonts as fallbacks
// Custom fonts (Google Fonts) can be registered here when needed
Font.register({
  family: 'Inter',
  fonts: [
...
// Hyphenation callback - disable to prevent word breaks
